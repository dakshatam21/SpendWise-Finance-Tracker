...
Project Scope :	
A responsive personal finance management web application that helps users track income, expenses, budgets, recurring payments, and savings goals with analytics and spending insights.
...
* Track subscriptions and fixed monthly expenses
...
All user data is stored locally using browser Local Storage. No backend or database is required.
